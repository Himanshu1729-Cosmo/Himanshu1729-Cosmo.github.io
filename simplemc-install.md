...
In the next page, we will explore the basic structure of \texttt{SimpleMC} and learn how to add a new dark energy model by considering the JBP (*Jassal–Bagla–Padmanabhan*) as an example.
